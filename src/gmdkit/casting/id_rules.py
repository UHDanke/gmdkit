...
ID_RULES = {
    ...
    obj_id.trigger.area.SCALE_EDIT: [
            {'type': 'group_id', 'property_id': prop_id.trigger.effect.TARGET_ID, 'condition': lambda x: x.get(prop_id.trigger.effect.USE_EFFECT_ID,0) == 1, 'min': 1, 'max': 9999, 'remappable': True, 'iterable': False}
        ],
    obj_id.trigger.area.ROTATE_EDIT: [
            {'type': 'group_id', 'property_id': prop_id.trigger.effect.TARGET_ID, 'condition': lambda x: x.get(prop_id.trigger.effect.USE_EFFECT_ID,0) == 2, 'min': 1, 'max': 9999, 'remappable': True, 'iterable': False}
        ],
    obj_id.trigger.area.FADE_EDIT: [
            {'type': 'group_id', 'property_id': prop_id.trigger.effect.TARGET_ID, 'condition': lambda x: x.get(prop_id.trigger.effect.USE_EFFECT_ID,0) == 3, 'min': 1, 'max': 9999, 'remappable': True, 'iterable': False}
        ],
    obj_id.trigger.area.TINT_EDIT: [
            {'type': 'group_id', 'property_id': prop_id.trigger.effect.TARGET_ID, 'condition': lambda x: x.get(prop_id.trigger.effect.USE_EFFECT_ID,0) == 4, 'min': 1, 'max': 9999, 'remappable': True, 'iterable': False}
        ],
