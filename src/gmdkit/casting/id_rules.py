...
ID_RULES = {
    ...
    obj_id.trigger.shader.LENS_CIRCLE: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.LENS_CIRCLE_TINT_CHANNEL, default=0, min=1, max=1101, remappable=True, reference=True),
    ...
    obj_id.trigger.shader.RADIAL_BLUR: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.RADIAL_BLUR_REF_CHANNEL, default=0, min=1, max=1101, remappable=True, reference=True),
    ...
    obj_id.trigger.shader.MOTION_BLUR: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.MOTION_BLUR_REF_CHANNEL, default=0, min=1, max=1101, remappable=True, reference=True),
    ...
    None: [
            IDRule(type='color_id', prop=obj_prop.COLOR_1, fallback=lambda x: COLOR_1_DEFAULT.get(x.get(obj_prop.ID,0)), default=0, min=1, max=1101, reference=True),
            IDRule(type='color_id', prop=obj_prop.COLOR_2, fallback=lambda x: COLOR_2_DEFAULT.get(x.get(obj_prop.ID,0)), default=0, min=1, max=1101, reference=True),
    ...
    obj_id.trigger.PULSE: [
            ...
            IDRule(type='color_id', prop=obj_prop.trigger.pulse.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.pulse.TARGET_TYPE,0) == 0, default=0, min=1, max=1101, remappable=True),
