...
ID_TYPES = {'material_id', 'force_id', 'enter_channel', 'trigger_channel', 'gradient_id', 'link_id', 'color_id', 'remap_target', 'unique_sfx_id', 'item_id', 'song_id', 'group_id', 'song_channel', 'control_id', 'keyframe_id', 'collision_id', 'effect_id', 'time_id', 'sfx_id', 'remap_base', 'sfx_group'}
