...
ID_RULES = {
    obj_id.trigger.COLOR: [
            IDRule(type='color_id', prop=obj_prop.trigger.color.CHANNEL, min=1, max=1101),
            IDRule(type='color_id', prop=obj_prop.trigger.color.COPY_ID, min=1, max=1101, reference=True)
        ],
    obj_id.trigger.shader.GRAY_SCALE: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.GRAY_SCALE_TINT_CHANNEL, default=lambda x: 0 if x.get(obj_prop.trigger.shader.GRAY_SCALE_USE_TINT) else None, min=1, max=1101, remappable=True, reference=True)
        ],
    obj_id.trigger.shader.LENS_CIRCLE: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.LENS_CIRCLE_TINT_CHANNEL, min=1, max=1101, remappable=True, reference=True),
    ...
    obj_id.trigger.shader.RADIAL_BLUR: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.RADIAL_BLUR_REF_CHANNEL, min=1, max=1101, remappable=True, reference=True),
    ...
    obj_id.trigger.shader.MOTION_BLUR: [
            IDRule(type='color_id', prop=obj_prop.trigger.shader.MOTION_BLUR_REF_CHANNEL, min=1, max=1101, remappable=True, reference=True),
    ...
    None: [
            IDRule(type='color_id', prop=obj_prop.COLOR_1, fallback=lambda x: COLOR_1_DEFAULT.get(x.get(obj_prop.ID,0)), min=1, max=1101, reference=True),
            IDRule(type='color_id', prop=obj_prop.COLOR_2, fallback=lambda x: COLOR_2_DEFAULT.get(x.get(obj_prop.ID,0)), min=1, max=1101, reference=True),
            ...
            IDRule(type='trigger_channel', prop=obj_prop.trigger.CHANNEL, reference=True),
            IDRule(type='enter_channel', prop=obj_prop.ENTER_CHANNEL, min=-32768, max=32767, reference=True),
            IDRule(type='material_id', prop=obj_prop.MATERIAL, min=-32768, max=32767, reference=True),
            IDRule(type='control_id', prop=obj_prop.trigger.CONTROL_ID, remappable=True, reference=True)
        ],
    obj_id.trigger.PULSE: [
            IDRule(type='color_id', prop=obj_prop.trigger.pulse.COPY_ID, min=1, max=1101, reference=True),
            IDRule(type='color_id', prop=obj_prop.trigger.pulse.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.pulse.TARGET_TYPE,0) == 0, min=1, max=1101, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.pulse.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.pulse.TARGET_TYPE,0) == 1, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.area.TINT: [
            IDRule(type='color_id', prop=obj_prop.trigger.effect.TINT_CHANNEL, default=lambda x: 0 if not x.get(obj_prop.trigger.effect.ENABLE_HSV) else None, min=1, max=1101, reference=True),
            ...
            IDRule(type='effect_id', prop=obj_prop.trigger.effect.EFFECT_ID, reference=True)
        ],
    obj_id.trigger.enter.TINT: [
            IDRule(type='color_id', prop=obj_prop.trigger.effect.TINT_CHANNEL, default=lambda x: 0 if not x.get(obj_prop.trigger.effect.ENABLE_HSV) else None, min=1, max=1101, reference=True),
            IDRule(type='effect_id', prop=obj_prop.trigger.effect.EFFECT_ID, reference=True),
            IDRule(type='enter_channel', prop=obj_prop.trigger.effect.ENTER_CHANNEL, min=-32768, max=32767, remappable=True)
        ],
    obj_id.LEVEL_START: [
    ...
    obj_id.trigger.MOVE: [
            IDRule(type='group_id', prop=obj_prop.trigger.move.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.move.TARGET_POS, default=lambda x: 0 if x.get(obj_prop.trigger.move.DIRECTION_MODE) or x.get(x.get(obj_prop.trigger.move.TARGET_MODE) else None, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.move.TARGET_CENTER_ID, default=lambda x: 0 if x.get(obj_prop.trigger.move.DIRECTION_MODE) or x.get(x.get(obj_prop.trigger.move.TARGET_MODE) else None, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.ALPHA: [
            IDRule(type='group_id', prop=obj_prop.trigger.alpha.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.TOGGLE: [
            IDRule(type='group_id', prop=obj_prop.trigger.toggle.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.TOGGLE_BLOCK: [
            IDRule(type='group_id', prop=obj_prop.trigger.toggle_block.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.orb.TOGGLE: [
            IDRule(type='group_id', prop=obj_prop.trigger.toggle_block.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.ON_DEATH: [
            IDRule(type='group_id', prop=obj_prop.trigger.on_death.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.SPAWN: [
            IDRule(type='group_id', prop=obj_prop.trigger.spawn.GROUP_ID, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.TELEPORT: [
            IDRule(type='group_id', prop=obj_prop.trigger.teleport.TARGET_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.EDIT_SONG: [
            ...
            IDRule(type='song_channel', prop=obj_prop.trigger.song.CHANNEL, min=0, max=4, remappable=True)
        ],
    obj_id.trigger.SFX: [
            ...
            IDRule(type='sfx_id', prop=obj_prop.trigger.sfx.SFX_ID, remappable=True, reference=True),
    ...
    obj_id.trigger.EDIT_SFX: [
            IDRule(type='group_id', prop=obj_prop.trigger.sfx.GROUP_ID_1, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.sfx.GROUP_ID_2, default=lambda x: 0 if not (x.get(obj_prop.trigger.sfx.PLAYER_1) or x.get(obj_prop.trigger.sfx.PLAYER_2) or x.get(obj_prop.trigger.sfx.CAMERA)) else None, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.sfx.GROUP, min=1, max=9999, remappable=True),
            IDRule(type='unique_sfx_id', prop=obj_prop.trigger.sfx.UNIQUE_ID, remappable=True),
            IDRule(type='sfx_group', prop=obj_prop.trigger.sfx.GROUP_ID, remappable=True)
        ],
    obj_id.trigger.ROTATE: [
            IDRule(type='group_id', prop=obj_prop.trigger.rotate.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.rotate.CENTER_ID, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.FOLLOW: [
            IDRule(type='group_id', prop=obj_prop.trigger.follow.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.follow.FOLLOW_TARGET, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.ANIMATE: [
            IDRule(type='group_id', prop=obj_prop.trigger.animate.TARGET_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.TOUCH: [
            IDRule(type='group_id', prop=obj_prop.trigger.touch.GROUP_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.COUNT: [
            IDRule(type='group_id', prop=obj_prop.trigger.count.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='item_id', prop=obj_prop.trigger.count.ITEM_ID, min=0, max=9999, remappable=True)
        ],
    obj_id.trigger.INSTANT_COUNT: [
            ...
            IDRule(type='item_id', prop=obj_prop.trigger.instant_count.ITEM_ID, min=0, max=9999, remappable=True, reference=True)
        ],
    ...
    obj_id.trigger.COLLISION: [
            IDRule(type='group_id', prop=obj_prop.trigger.collision.TARGET_ID, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.RANDOM: [
            IDRule(type='group_id', prop=obj_prop.trigger.random.TRUE_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.random.FALSE_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.END_WALL: [
            IDRule(type='group_id', prop=obj_prop.trigger.end_wall.GROUP_ID, min=1, max=9999)
        ],
    obj_id.trigger.CAMERA_EDGE: [
            IDRule(type='group_id', prop=obj_prop.trigger.camera_edge.TARGET_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.CHECKPOINT: [
            IDRule(type='group_id', prop=obj_prop.trigger.checkpoint.SPAWN_ID, min=1, max=9999),
            IDRule(type='group_id', prop=obj_prop.trigger.checkpoint.TARGET_POS, min=1, max=9999),
            IDRule(type='group_id', prop=obj_prop.trigger.checkpoint.RESPAWN_ID, min=1, max=9999)
        ],
    obj_id.trigger.SCALE: [
            IDRule(type='group_id', prop=obj_prop.trigger.scale.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.scale.CENTER_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.ADV_FOLLOW: [
            IDRule(type='group_id', prop=obj_prop.trigger.adv_follow.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.adv_follow.FOLLOW_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.adv_follow.MAX_RANGE_REF, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.adv_follow.START_SPEED_REF, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.adv_follow.START_DIR_REF, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.KEYFRAME: [
            ...
            IDRule(type='keyframe_id', prop=obj_prop.trigger.keyframe.KEY_ID, min=0, reference=True)
        ],
    obj_id.trigger.ANIMATE_KEYFRAME: [
            ...
            IDRule(type='group_id', prop=obj_prop.trigger.animate_keyframe.PARENT_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.animate_keyframe.ANIMATION_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.END: [
            IDRule(type='group_id', prop=obj_prop.trigger.end.SPAWN_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.end.TARGET_POS, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.EVENT: [
            IDRule(type='group_id', prop=obj_prop.trigger.event.SPAWN_ID, min=1, max=9999, remappable=True),
            IDRule(type='material_id', prop=obj_prop.trigger.event.EXTRA_ID_1, remappable=True)
        ],
    obj_id.trigger.SPAWN_PARTICLE: [
            ...
            IDRule(type='group_id', prop=obj_prop.trigger.spawn_particle.POSITION_GROUP, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.INSTANT_COLLISION: [
            IDRule(type='group_id', prop=obj_prop.trigger.instant_collision.TRUE_ID, min=1, max=9999, remappable=True),
            IDRule(type='group_id', prop=obj_prop.trigger.instant_collision.FALSE_ID, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.UI: [
            IDRule(type='group_id', prop=obj_prop.trigger.ui.GROUP_ID, min=1, max=9999),
            IDRule(type='group_id', prop=obj_prop.trigger.ui.UI_TARGET, min=1, max=9999)
        ],
    obj_id.trigger.TIME: [
            IDRule(type='group_id', prop=obj_prop.trigger.time.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='time_id', prop=obj_prop.trigger.time.ITEM_ID, remappable=True, reference=True)
        ],
    obj_id.trigger.TIME_EVENT: [
            IDRule(type='group_id', prop=obj_prop.trigger.time_event.TARGET_ID, min=1, max=9999, remappable=True),
            IDRule(type='time_id', prop=obj_prop.trigger.time_event.ITEM_ID, remappable=True, reference=True)
        ],
    ...
    obj_id.trigger.OBJECT_CONTROL: [
            IDRule(type='group_id', prop=obj_prop.trigger.object_control.TARGET_ID, min=1, max=9999)
        ],
    obj_id.trigger.LINK_VISIBLE: [
            IDRule(type='group_id', prop=obj_prop.trigger.link_visible.GROUP_ID, min=1, max=9999)
        ],
    obj_id.trigger.ITEM_COMPARE: [
            ...
            IDRule(type='item_id', prop=obj_prop.trigger.item_compare.ITEM_ID_1, condition=lambda x: x.get(obj_prop.trigger.item_compare.ITEM_TYPE_1,0) in (0,1), min=0, max=9999, remappable=True, reference=True),
            IDRule(type='time_id', prop=obj_prop.trigger.item_compare.ITEM_ID_1, condition=lambda x: x.get(obj_prop.trigger.item_compare.ITEM_TYPE_1,0) == 2, min=0, max=9999, remappable=True, reference=True),
            IDRule(type='item_id', prop=obj_prop.trigger.item_compare.ITEM_ID_2, condition=lambda x: x.get(obj_prop.trigger.item_compare.ITEM_TYPE_2,0) in (0,1), min=1, max=9999, remappable=True, reference=True),
            IDRule(type='time_id', prop=obj_prop.trigger.item_compare.ITEM_ID_2, condition=lambda x: x.get(obj_prop.trigger.item_compare.ITEM_TYPE_2,0) == 2, min=1, max=9999, remappable=True, reference=True)
        ],
    obj_id.trigger.STATE_BLOCK: [
            IDRule(type='group_id', prop=obj_prop.trigger.state_block.STATE_ON, min=1, max=9999),
            IDRule(type='group_id', prop=obj_prop.trigger.state_block.STATE_OFF, min=1, max=9999)
        ],
    obj_id.trigger.STATIC_CAMERA: [
            IDRule(type='group_id', prop=obj_prop.trigger.static_camera.TARGET_ID, min=1, max=9999, remappable=True)
        ],
    obj_id.trigger.GRADIENT: [
            IDRule(type='group_id', prop=obj_prop.trigger.gradient.U, min=1, max=9999),
            ...
            IDRule(type='gradient_id', prop=obj_prop.trigger.gradient.GRADIENT_ID, min=0, max=1000, reference=True)
        ],
    ...
    obj_id.trigger.STOP: [
            ...
            IDRule(type='control_id', prop=obj_prop.trigger.stop.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.stop.USE_CONTROL_ID,0) == 1, remappable=True)
        ],
    ...
    obj_id.trigger.EDIT_ADV_FOLLOW: [
            ...
            IDRule(type='control_id', prop=obj_prop.trigger.edit_adv_follow.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.edit_adv_follow.USE_CONTROL_ID,0) == 1, remappable=True)
        ],
    ...
    obj_id.collectible.USER_COIN: [
            ...
            IDRule(type='item_id', prop=obj_prop.trigger.collectible.ITEM_ID, min=0, max=9999)
        ],
    ...
    obj_id.trigger.area.EDIT_MOVE: [
            ...
            IDRule(type='effect_id', prop=obj_prop.trigger.effect.TARGET_ID, condition=lambda x: x.get(obj_prop.trigger.effect.USE_EFFECT_ID,0) == 1, remappable=True)
        ],
    ...
    obj_id.ITEM_LABEL: [
            IDRule(type='item_id', prop=obj_prop.item_label.ITEM_ID, condition=lambda x: x.get(obj_prop.item_label.TIME_COUNTER,0) == 0, min=0, max=9999, reference=True),
            IDRule(type='time_id', prop=obj_prop.item_label.ITEM_ID, condition=lambda x: x.get(obj_prop.item_label.TIME_COUNTER,0) == 1, min=0, max=9999, reference=True)
        ],
    obj_id.trigger.PICKUP: [
            IDRule(type='item_id', prop=obj_prop.trigger.pickup.ITEM_ID, min=0, max=9999, remappable=True)
        ],
    obj_id.trigger.TIME_CONTROL: [
            IDRule(type='time_id', prop=obj_prop.trigger.time_control.ITEM_ID, remappable=True)
        ],
    obj_id.trigger.ITEM_PERSIST: [
            IDRule(type='item_id', prop=obj_prop.trigger.item_persist.ITEM_ID, condition=lambda x: x.get(obj_prop.trigger.item_persist.TIMER,0) == 0, min=0, max=9999, remappable=True),
            IDRule(type='time_id', prop=obj_prop.trigger.item_persist.ITEM_ID, condition=lambda x: x.get(obj_prop.trigger.item_persist.TIMER,0) == 1, remappable=True)
        ],
    ...
    obj_id.trigger.ARROW: [
            IDRule(type='trigger_channel', prop=obj_prop.trigger.arrow.TARGET_CHANNEL, reference=True)
        ],
    obj_id.trigger.START_POSITION: [
            IDRule(type='trigger_channel', prop=obj_prop.start_pos.TARGET_CHANNEL)
        ],
    obj_id.trigger.area.STOP: [
            IDRule(type='effect_id', prop=obj_prop.trigger.effect.TARGET_ID, remappable=True, reference=True)
        ],
    ...
    obj_id.trigger.enter.STOP: [
            IDRule(type='effect_id', prop=obj_prop.trigger.effect.EFFECT_ID),
            IDRule(type='enter_channel', prop=obj_prop.trigger.effect.ENTER_CHANNEL, min=-32768, max=32767, remappable=True)
        ],
    22: [
            IDRule(type='enter_channel', prop=obj_prop.trigger.enter_preset.ENTER_CHANNEL, min=-32768, max=32767, remappable=True)
        ],
    24: [
            IDRule(type='enter_channel', prop=obj_prop.trigger.enter_preset.ENTER_CHANNEL, min=-32768, max=32767, remappable=True)
        ],
    ...
    obj_id.trigger.SONG: [
            IDRule(type='song_id', prop=obj_prop.trigger.song.SONG_ID, remappable=True, reference=True),
            IDRule(type='song_channel', prop=obj_prop.trigger.song.CHANNEL, min=0, max=4, remappable=True, reference=True)
        ],
    obj_id.trigger.FORCE_BLOCK: [
            IDRule(type='force_id', prop=obj_prop.trigger.force_block.FORCE_ID, reference=True)
        ],
    obj_id.trigger.FORCE_CIRCLE: [
            IDRule(type='force_id', prop=obj_prop.trigger.force_block.FORCE_ID, min=-32768, max=32767, reference=True)
        ]
    }
