...
ID_RULES = RuleHandler(
    ...
    obj_id.trigger.MOVE: (
            IDRule(type='group_id', prop=obj_prop.trigger.move.TARGET_ID, default=0, actions={'get_position', 'move', 'get_rand'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.TOGGLE_BLOCK: (
            IDRule(type='group_id', prop=obj_prop.trigger.toggle_block.GROUP_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True)
        ,),
    obj_id.orb.TOGGLE: (
            IDRule(type='group_id', prop=obj_prop.trigger.toggle_block.GROUP_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True)
        ,),
    obj_id.trigger.ON_DEATH: (
            IDRule(type='group_id', prop=obj_prop.trigger.on_death.GROUP_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True)
        ,),
    ...
    obj_id.trigger.ROTATE: (
            IDRule(type='group_id', prop=obj_prop.trigger.rotate.TARGET_ID, default=0, actions={'rotate', 'get_position', 'move', 'get_rand'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.TOUCH: (
            IDRule(type='group_id', prop=obj_prop.trigger.touch.GROUP_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True)
        ,),
    obj_id.trigger.COUNT: (
            IDRule(type='group_id', prop=obj_prop.trigger.count.TARGET_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.INSTANT_COUNT: (
            IDRule(type='group_id', prop=obj_prop.trigger.instant_count.TARGET_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.COLLISION: (
            IDRule(type='group_id', prop=obj_prop.trigger.collision.TARGET_ID, default=0, actions={'toggle', 'spawn'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.SCALE: (
            IDRule(type='group_id', prop=obj_prop.trigger.scale.TARGET_ID, default=0, actions={'move', 'scale'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.KEYFRAME: (
            IDRule(type='group_id', prop=obj_prop.trigger.keyframe.GROUP_ID, default=lambda x: 0 if x.get(obj_prop.trigger.keyframe.INDEX,0) == 1 else None, actions={'rotate', 'move', 'scale'}, min=1, max=9999),
    ...
    obj_id.trigger.ANIMATE_KEYFRAME: (
            IDRule(type='group_id', prop=obj_prop.trigger.animate_keyframe.TARGET_ID, default=0, actions={'rotate', 'move', 'scale'}, min=1, max=9999, remappable=True),
    ...
    obj_id.trigger.UI: (
            ...
            IDRule(type='group_id', prop=obj_prop.trigger.ui.UI_TARGET, default=0, actions={'set_ui', 'move'}, min=1, max=9999)
        ),
    obj_id.trigger.TIME: (
    ...
    obj_id.collectible.USER_COIN: (
            IDRule(type='group_id', prop=obj_prop.trigger.collectible.GROUP_ID, default=lambda x: 0 if x.get(obj_prop.trigger.collectible.TOGGLE_TRIGGER) else None, actions={'toggle', 'spawn'}, min=1, max=9999),
