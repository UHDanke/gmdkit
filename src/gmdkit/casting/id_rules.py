...
ID_TYPES = {'material_id', 'group_id', 'sfx_group', 'collision_id', 'gradient_id', 'trigger_channel', 'link_id', 'enter_channel', 'color_id', 'effect_id', 'unique_sfx_id', 'sfx_id', 'keyframe_id', 'song_channel', 'remap_target', 'remap_base', 'song_id', 'control_id', 'item_id', 'force_id', 'time_id'}
