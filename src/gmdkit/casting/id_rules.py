...
ID_TYPES = {'color_id', 'force_id', 'material_id', 'group_id', 'song_channel', 'effect_id', 'keyframe_id', 'item_id', 'collision_id', 'remap_target', 'time_id', 'sfx_id', 'enter_channel', 'song_id', 'unique_sfx_id', 'control_id', 'link_id', 'gradient_id', 'trigger_channel', 'sfx_group', 'remap_base'}
...
ID_RULES = RuleHandler(
    ...
    obj_id.trigger.ROTATE: (
            IDRule(id_type='group_id', obj_prop_id=obj_prop.trigger.rotate.TARGET_ID, default=0, actions={'get_rand', 'rotate', 'get_position', 'move'}, remappable=True, id_min=1, id_max=9999),
