...
ID_TYPES = {'trigger_channel', 'item_id', 'group_id', 'collision_id', 'sfx_group', 'keyframe_id', 'color_id', 'remap_target', 'effect_id', 'link_id', 'song_channel', 'control_id', 'material_id', 'song_id', 'gradient_id', 'enter_channel', 'force_id', 'sfx_id', 'unique_sfx_id', 'remap_base', 'time_id'}
...
ID_RULES = RuleHandler(
    ...
    obj_id.trigger.ROTATE: (
            IDRule(id_type='group_id', obj_prop_id=obj_prop.trigger.rotate.TARGET_ID, default=0, actions={'get_position', 'get_rand', 'rotate', 'move'}, remappable=True, id_min=1, id_max=9999),
