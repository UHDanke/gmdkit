...
ID_TYPES = {'keyframe_id', 'sfx_id', 'unique_sfx_id', 'collision_id', 'color_id', 'material_id', 'sfx_group', 'remap_base', 'song_channel', 'force_id', 'effect_id', 'item_id', 'trigger_channel', 'remap_target', 'enter_channel', 'group_id', 'gradient_id', 'time_id', 'song_id', 'link_id', 'control_id'}
