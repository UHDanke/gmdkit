...
ID_TYPES = {'group_id', 'unique_sfx_id', 'song_id', 'item_id', 'remap_target', 'control_id', 'link_id', 'sfx_id', 'color_id', 'time_id', 'sfx_group', 'gradient_id', 'collision_id', 'trigger_channel', 'remap_base', 'enter_channel', 'force_id', 'effect_id', 'material_id', 'song_channel', 'keyframe_id'}
...
ID_RULES = RuleHandler(
    ...
    obj_id.trigger.MOVE: (
            IDRule(id_type='group_id', obj_prop_id=obj_prop.trigger.move.TARGET_ID, default=0, actions={'move', 'get_position', 'get_rand'}, remappable=True, id_min=1, id_max=9999),
