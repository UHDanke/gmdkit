...
ID_TYPES = {'collision_id', 'force_id', 'unique_sfx_id', 'effect_id', 'sfx_group', 'link_id', 'item_id', 'control_id', 'enter_channel', 'group_id', 'remap_base', 'time_id', 'song_channel', 'material_id', 'color_id', 'trigger_channel', 'song_id', 'gradient_id', 'keyframe_id', 'remap_target', 'sfx_id'}
...
ID_RULES = RuleHandler(
    ...
    obj_id.trigger.ROTATE: (
            IDRule(id_type='group_id', obj_prop_id=obj_prop.trigger.rotate.TARGET_ID, default=0, actions={'move', 'rotate', 'get_rand', 'get_position'}, remappable=True, id_min=1, id_max=9999),
