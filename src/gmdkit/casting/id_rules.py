...
ID_TYPES = {'effect_id', 'force_id', 'remap_base', 'collision_id', 'keyframe_id', 'remap_target', 'material_id', 'song_channel', 'song_id', 'unique_sfx_id', 'gradient_id', 'item_id', 'enter_channel', 'time_id', 'sfx_id', 'trigger_channel', 'color_id', 'group_id', 'link_id', 'control_id', 'sfx_group'}
