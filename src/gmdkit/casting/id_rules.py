...
ID_TYPES = {'control_id', 'remap_base', 'sfx_id', 'sfx_group', 'collision_id', 'color_id', 'link_id', 'force_id', 'time_id', 'gradient_id', 'remap_target', 'song_channel', 'enter_channel', 'material_id', 'effect_id', 'song_id', 'group_id', 'item_id', 'unique_sfx_id', 'keyframe_id', 'trigger_channel'}
