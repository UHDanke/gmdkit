...
def next_free(
    ...
    vmin : int, optional
        The minimum value that can be returned. Defaults to -2**31.
    vmax : int, optional
        The maximum value that can be returned. Defaults to 2**31-1.
    count : int, optional
    ...
    if not l:
        ...
        raise ValueError(f"Could only retrieve {l} ids out of {count} from range")
