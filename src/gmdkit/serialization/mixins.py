...
class DefaultPathMixin(FileStringMixin):
    ...
    DEFAULT_PATH: ClassVar[Optional[PathString]] = None
...
class PlistDecoderMixin(FileStringMixin):
    ...
    ENCODER: ClassVar[Optional[PlistEncoder]] = None
    DECODER: ClassVar[Optional[PlistDecoder]] = None
    CONTAINER: ClassVar[Optional[str]] = None
    ENCODER_KEY: ClassVar[Optional[int]] = None
    IS_ARRAY: ClassVar[bool] = False
    path: PathString
...
class DataclassDecoderMixin:
    ...
    ENCODER: ClassVar[Optional[StringDictEncoder]] = staticmethod(dict_serializer)
    DECODER: ClassVar[Optional[StringDictDecoder]] = None
    CONDITION: ClassVar[Optional[KeyValueCondition]] = None
    FROM_ARRAY: ClassVar[bool] = True
    SEPARATOR: ClassVar[str] = ','
    MAX_SPLIT: ClassVar[Optional[int]] = None
    ...
    def to_tokens(
        ...
        field_data = [
            (key, getattr(self, key)) for key in get_field_names_ordered(cls)
            ]
...
class ArrayDecoderMixin:
    ...
    ENCODER: ClassVar[Optional[StringEncoder]] = staticmethod(serialize)
    DECODER: ClassVar[Optional[StringDecoder]] = None
    CONTAINER: ClassVar[Optional[str]] = None
    GROUP_SIZE: ClassVar[int] = 1
    SEPARATOR: ClassVar[str] = ','
    KEEP_SEPARATOR: ClassVar[bool] = False
...
class DelimiterMixin:
    ...
    START_DELIMITER: ClassVar[Optional[str]] = None
    END_DELIMITER: ClassVar[Optional[str]] = None
...
class CompressFileMixin:
    ...
    COMPRESSION: ClassVar[Optional[Literal['zlib', 'gzip', 'deflate']]] = None
    CYPHER: ClassVar[Optional[bytes]] = None
...
class PlistLoaderMixin(PlistDecoderMixin):
    ...
    SELECTORS: ClassVar[Optional[set]] = None
    LOAD_CONTENT: ClassVar[bool] = True
    SAVE_CONTENT: ClassVar[bool] = True
...
class FolderLoaderMixin:
    ...
    FOLDER_DECODER: ClassVar[Optional[Callable]] = None
    FOLDER_ENCODER: ClassVar[Optional[Callable]] = None
    FOLDER_EXTENSION: ClassVar[Optional[str]] = None
    CONTAINER: ClassVar[Optional[str]] = None
...
class DictDefaultsMixin:
    ...
    def init_keys(self, *keys, override:bool=False):
        cls = type(self)
